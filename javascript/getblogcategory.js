var blogcategorytableData = new Map();//from getallstaff.php names only
...
function getcategory(){
     $.ajax({
         type: "GET",
         url: api_url+"getAllBlogCategory.php",
         ...
         success: function(response) {
           ...
           var count;
            ...
            {
            blogcategorytableData.set(response.Data[i].categoryId,response.Data[i]);
            }
