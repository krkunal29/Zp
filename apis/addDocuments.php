...
if(isset($_POST['documents'])){
    $query = "INSERT INTO DocType(DocTypeDesc) VALUES('$documents')";
    $jobQuery = mysqli_query($conn,$query);
if($jobQuery==1)
    {
        $last_id = mysqli_insert_id($conn);
        $s = strval($last_id);
        $sql = "SELECT * FROM DocType WHERE DocTypeID = $s";
    ...
    $response = array('Message'=>"All Document  Data Inserted Successfully","Data"=>$records ,'Responsecode'=>200);
		}else{
