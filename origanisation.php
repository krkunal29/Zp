            ...
            <div class="page-wrap">
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div id="neworiganisation"></div>
                        <div class="row origanisationlist">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table  class="table" id="origanisationmaintbl">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody class="origanisationmainData">
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
               ...
               <?php include "dashboardmodal.php"; ?>
                ...
                <script src="jscode/undefinedOriganisationType.js"></script>
                <script src="jscode/getallorgnizationtypelist.js">  </script>

                <script src="jscode/getallorgnizationlist.js"></script>
                <script src="jscode/orgnization.js"></script>
